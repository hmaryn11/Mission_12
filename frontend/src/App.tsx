...
// :)
// data for the NCAA Basketball team in json form
const teamNames = [
...
// :)
// class shoing the information  we want to show for each team
//some styling is also included
...
// :)
// the h1 tag to show what we are looking at
function Welcome(){
  return(<h1>NCAA BasketBall Teams</h1>);
}

// :)
//compliling all of the team names into one list
function TeamList(){
  return(
    <div>
...
//creating a function to combine all funtions we are using for this all
function App() {
  return (
    <div className="App">
      <Welcome/>
